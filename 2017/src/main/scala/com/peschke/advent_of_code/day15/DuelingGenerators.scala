...
object DuelingGenerators extends AdventOfCodeDay {
  ...
  def verifyPart1Samples(): Unit = {
    ...
    println("--- parsing ---")
    println(verifyResult(parse _)(sampleInput, Seq(genA, genB)))
    ...
    println("\n--- judging ---")
    println(verifyResult(passJudgement _)(sampleInput, BigInt(588)))
  }
  ...
  def verifyPart2Samples(): Unit = {
    ...
    println("\n--- judging ---")
    println(verifyResult(passJudgement _)(sampleInput, BigInt(309)))
  }
}
